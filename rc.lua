-- Note, you'll need to install dmenu, thunar,compton, nitrogen  to use
...
-- keyboard layouts 22-May-2020
kbdcfg = layout_indicator({
    layouts = {
        {name="English-US",  layout="us",  variant=nil},
        {name="Русский",  layout="ru",  variant=nil}
    },
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,         }, "z", function() kbdcfg:next() end ,
...
--launch proton vpn
    ...
    awful.key({ modkey },            "v",     function () 
        awful.spawn(terminal.." -e sudo protonvpn connect") end,
        {description = "Proton VPN", group="Applications"}),
